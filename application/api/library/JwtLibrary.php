...
use app\api\library\JwtCore\JWT;
class JwtLibrary
{
    public $refreshToken;
    public $key = 'abc123';
    public $time;
    public $iss = 'waltkong@github.com';   //签发者 可选
    public $aud = 'waltkong@github.com';   //接受者 可选
    public $expire_time;
    public $refresh_time;

    public function __construct ($expire_time=86400){
        $this->time = time();
        $this->expire_time = $expire_time; //过期时间,这里默认设置一天吧

define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wk_member_likes/index' + location.search,
                    add_url: 'wk_member_likes/add',
                    edit_url: 'wk_member_likes/edit',
                    del_url: 'wk_member_likes/del',
                    multi_url: 'wk_member_likes/multi',
                    table: 'wk_member_likes',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'wk_member_likes/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [

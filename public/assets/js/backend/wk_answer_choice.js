define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wk_answer_choice/index' + location.search,
                    add_url: 'wk_answer_choice/add',
                    edit_url: 'wk_answer_choice/edit',
                    del_url: 'wk_answer_choice/del',
                    multi_url: 'wk_answer_choice/multi',
                    table: 'wk_answer_choice',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'wk_answer_choice/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [

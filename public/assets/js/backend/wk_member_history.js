define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wk_member_history/index' + location.search,
                    add_url: 'wk_member_history/add',
                    edit_url: 'wk_member_history/edit',
                    del_url: 'wk_member_history/del',
                    multi_url: 'wk_member_history/multi',
                    table: 'wk_member_history',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'wk_member_history/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
